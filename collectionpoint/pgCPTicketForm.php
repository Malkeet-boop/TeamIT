        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Collection Point Tickets</h4>
		...
		$.ajax({
			...
			success:function(response){
				...
				if($.trim(response)=="Success"){
					showAlertRedirect("Success","Data Added Successfully","success","pgCPOldTicket.php");
					$("#txtsubject").val("");
					$("#txtdescription").val("");
